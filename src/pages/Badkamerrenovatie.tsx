...
const Badkamerrenovatie = () => {
  ...
  const specializations = [
    "Complete badkamerrenovatie van A tot Z",
    "Moderne sanitair en design installaties",
    "Tegelwerk en waterdichte afwerkingen",
    "Loodgieterswerk en elektrische installaties",
    "Vloerverwarming en luxe wellness oplossingen"
  ];

  const recentProjects = [
    "Luxe badkamer renovatie villa Hasselt-Centrum",
    "Moderne badkamer appartement Genk",
    "Wellness badkamer herenhuis Sint-Truiden",
    "Compact badkamer design studio Tongeren"
  ];

  const stats = [
    { number: "300+", label: "Badkamers gerenoveerd", icon: Bath },
  ...
  return (
    <>
      <Helmet>
        <title>Badkamerrenovatie Hasselt | MMT Projects - Professionele Badkamer Limburg</title>
        <meta name="description" content="Badkamerrenovatie specialist in Hasselt en omgeving. MMT Projects renoveert badkamers vakkundig met 15+ jaar ervaring. Gratis offerte voor badkamerrenovatie in Hasselt, Genk, Sint-Truiden en heel Limburg." />
        <meta name="keywords" content="badkamerrenovatie hasselt, badkamer renovatie limburg, sanitair installatie, tegelwerk badkamer" />
        <link rel="canonical" href="https://www.mmtprojects.be/badkamerrenovatie-hasselt-limburg" />
        
        <meta property="og:title" content="Badkamerrenovatie Hasselt | MMT Projects - Professionele Badkamer Limburg" />
        <meta property="og:description" content="Badkamerrenovatie specialist in Hasselt en omgeving. MMT Projects renoveert badkamers vakkundig met 15+ jaar ervaring." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.mmtprojects.be/badkamerrenovatie-hasselt-limburg" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Badkamerrenovatie Hasselt | MMT Projects - Professionele Badkamer Limburg" />
        <meta name="twitter:description" content="Badkamerrenovatie specialist in Hasselt en omgeving. MMT Projects renoveert badkamers vakkundig met 15+ jaar ervaring." />
      </Helmet>
      ...
      <div className="min-h-screen bg-white">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
                    Complete <span className="text-blue-600">Badkamerrenovatie</span> in Hasselt
                  </h1>
                  
                  <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                    Droomt u van een nieuwe badkamer? MMT Projects is uw specialist voor complete badkamerrenovaties in Hasselt en Limburg. Van ontwerp tot oplevering - alles uit één hand.
                  </p>
                </div>
              ...
              <div className="relative">
                <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
                  <img 
                    ...
                    alt="Badkamerrenovatie Hasselt" 
                    className="w-full h-[500px] object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent"></div>
                  <div className="absolute bottom-0 left-0 p-8 text-white">
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4">
                      <h3 className="text-2xl font-bold mb-2">Luxe Badkamers</h3>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-gray-900">
                Onze Badkamerrenovatie Services
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Van ontwerp tot installatie - MMT Projects verzorgt uw complete badkamerrenovatie in Hasselt en omgeving met oog voor detail en kwaliteit.
              </p>
            </div>
        ...
        <section className="py-24 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-gray-900">
                Badkamerrenovatie in Heel Limburg
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                MMT Projects verzorgt professionele badkamerrenovaties in Hasselt en omliggende gemeenten binnen een straal van 50 kilometer.
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    {serviceAreas.slice(0, 3).map((area, index) => (
                      <div key={index} className="flex items-center p-4 bg-blue-50 rounded-xl">
                        ...
                        <div>
                          <span className="font-semibold text-gray-900">Badkamerrenovatie {area}</span>
        ...
        <section className="py-24 px-4 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-gray-900">
                Recente Badkamerrenovatie Projecten
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ontdek onze laatst gerealiseerde badkamerrenovaties in Hasselt en omgeving.
              </p>
            </div>
            ...
            <div className="text-center space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                  Klaar voor uw droombadkamer? Neem contact op voor een vrijblijvend adviesgesprek en gratis offerte.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-8">
              <h3 className="text-2xl font-bold text-gray-900">
                MMT Projects - Uw Badkamerrenovatie Specialist
              </h3>
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Professionele badkamerrenovatie specialist in Hasselt en heel Limburg. 
                Van ontwerp tot oplevering - uw droomladkamer wordt werkelijkheid.
              </p>
            </div>
          </div>
        </section>
