      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-12 md:p-16 rounded-3xl shadow-xl">
              <div className="text-center">
                <h2 className="text-3xl sm:text-4xl font-bold mb-6">Start Uw Metselwerkproject in Hasselt</h2>
                <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                  Klaar voor vakkundig metselwerk? MMT Projects staat klaar om uw metselwerkproject in Hasselt of omgeving te realiseren.
                </p>
        ...
        <section className="py-12 px-4 bg-gray-100">
          <div className="max-w-7xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-4 text-gray-900">Contact MMT Projects - Metselwerk Specialist Hasselt</h3>
            ...
            <p className="mt-6 text-gray-600">
              MMT Projects - Uw betrouwbare partner voor metselwerk in Hasselt, Genk, Sint-Truiden en heel Limburg.
            </p>
          </div>
        </section>
      </div>
