            ...
            <div className="text-center space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">
                  Start Uw Schutting Project
                </h2>
                <p className="text-xl text-green-100 max-w-2xl mx-auto">
                  Klaar voor meer privacy in uw tuin? Neem contact op voor een vrijblijvend adviesgesprek en gratis offerte.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-8">
              <h3 className="text-2xl font-bold text-gray-900">
                MMT Projects - Uw Schuttingen Specialist
              </h3>
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Professionele schuttingen specialist in Hasselt en heel Limburg. 
                Van advies tot plaatsing - uw privacy wordt gegarandeerd.
              </p>
            </div>
          </div>
        </section>
