                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <div className="grid w-[600px] grid-cols-2 gap-3 p-4">
                      ...
                      <NavigationMenuLink href="/carport-hasselt-limburg" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                        <div className="text-sm font-medium leading-none">Carport</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                          Professionele carportbouw in Limburg
                        </p>
                      </NavigationMenuLink>
                    </div>
                  </NavigationMenuContent>
                ...
                <div className="flex flex-col gap-6 mt-8">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-2 ml-4">
                      ...
                      <a href="/carport-hasselt-limburg" className="text-base text-gray-600" onClick={() => setMobileMenuOpen(false)}>
                        Carport
                      </a>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/carport-hasselt-limburg" className="hover:text-white">Carport</Link></li>
              </ul>
            </div>
            <div>
